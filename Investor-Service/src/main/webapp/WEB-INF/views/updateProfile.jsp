...
<input type="hidden" name="investorEmail" id="investorEmail" value="${investorEmail}">
    ...
    <script>
        document.getElementById('updateProfileLink').onclick = function(event) {
            ...
            var email = document.getElementById('investorEmail').value;
            ...
            window.location.href = '/updateProfile/' + encodedEmail; // Ensure this matches your controller's path
        };
        document.getElementById('updateEmailLink').onclick = function() {
            var email = document.getElementById('investorEmail').value;
            var encodedEmail = encodeURIComponent(email);
            window.location.href = '/updateEmail/' + encodedEmail; // Redirect with email
        };
        ...
        document.getElementById('updatePasswordLink').onclick = function() {
            var email = document.getElementById('investorEmail').value;
            var encodedEmail = encodeURIComponent(email);
            window.location.href = '/updatePassword/' + encodedEmail; // Redirect with email
        };
    </script>
</body>
</html>
