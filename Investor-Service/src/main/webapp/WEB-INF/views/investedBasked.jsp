...
<body>
    ...
    <p>Units Bought: ${investment.units}</p>
        ...
        <tbody>
            <c:forEach var="stock" items="${basket.stocks}">
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${stock.closingPrice > stock.previousClosingPrice}">
                                <span style="color: green;">+${(stock.closingPrice - stock.previousClosingPrice) / stock.previousClosingPrice * 100}%</span>
                            </c:when>
                            <c:otherwise>
                                <span style="color: red;">${(stock.closingPrice - stock.previousClosingPrice) / stock.previousClosingPrice * 100}%</span>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
